...
trait ProcessHandleResultTrait {
    ...
    public function handle(LogRecord $record): bool
    {
        ...
        try {
            ...
            $e = new HandlerException('Failed to handle log record by ' . __CLASS__ . ' handler', 0, $throwable);
    ...
    protected function trackHandleErrorForDisabling(): self
    {
        ...
        if ($this->handleFailsLeftToDisableHandler <= 0) {
            if ($this->handleExceptionHandler) {
                $e = new HandlerException('Handler ' . __CLASS__ . ' was disabled after reaching max amount ' .
